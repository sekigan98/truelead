...
function statusClass(status) {
  ...
  if (['pending', 'pending_email', 'pending_validation', 'trial_pending_email', 'trial', 'free', 'free_pending_email', 'skipped', 'intent', 'proof_received'].includes(status)) return 'yellow';
